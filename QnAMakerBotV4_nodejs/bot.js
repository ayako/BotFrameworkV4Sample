...
class QnAMakerBot {
    ...
    async onTurn(turnContext) {
        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            // Get Top 3 answers, and score > 0.5
            const qnaResults = await this.qnaMaker.generateAnswer(turnContext.activity.text, 3, 0.5);
            ...
            // If no answers were returned from QnA Maker, reply with help.
                ...
                await turnContext.sendActivity('QnAMaker で回答が見つかりませんでした。\n別の文章でお試しください');
            }

        // If the Activity is a ConversationUpdate, send a greeting message to the user.
        } else if (turnContext.activity.type === ActivityTypes.ConversationUpdate &&
                   turnContext.activity.recipient.id !== turnContext.activity.membersAdded[0].id) {
            await turnContext.sendActivity('こんにちは！QnAMaker Bot です。\n質問を入力してください');
